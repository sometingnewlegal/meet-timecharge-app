...
export async function createScheduleRequest({ title, email, rate, durationMinutes, candidates }) {
...
export async function createBooking({ clientId, title, rate, scheduledAt, meetingCode, meetingUri, calendarEventId }) {
  const db = await readDB();
  const session = {
